/* eslint-disable */
// Generated by Wrangler by running `wrangler types env.d.ts` (hash: 369faa2ca83ac65b15980cdb5b8b1401)
// Runtime types generated with workerd@1.20260317.1 2026-03-27 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "VaniAgent";
	}
	interface Env {
		CACHE: KVNamespace;
		...
		AI: Ai;
		S3_API: string;
		VANI_AGENT: DurableObjectNamespace<import("./src/server").VaniAgent>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "S3_API">> {}
}
