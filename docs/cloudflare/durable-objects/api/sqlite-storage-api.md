...
[Skip to content](https://developers.cloudflare.com/durable-objects/api/sqlite-storage-api/#_top)
...
1 Each method is implicitly wrapped inside a transaction, such that
...
- [JavaScript](https://developers.cloudflare.com/durable-objects/api/sqlite-storage-api/#tab-panel-4647)
- [TypeScript](https://developers.cloudflare.com/durable-objects/api/sqlite-storage-api/#tab-panel-4648)
- [Python](https://developers.cloudflare.com/durable-objects/api/sqlite-storage-api/#tab-panel-4649)
...
- [TypeScript](https://developers.cloudflare.com/durable-objects/api/sqlite-storage-api/#tab-panel-4639)
- [Python](https://developers.cloudflare.com/durable-objects/api/sqlite-storage-api/#tab-panel-4640)
...
- [TypeScript](https://developers.cloudflare.com/durable-objects/api/sqlite-storage-api/#tab-panel-4641)
- [Python](https://developers.cloudflare.com/durable-objects/api/sqlite-storage-api/#tab-panel-4642)
...
- [TypeScript](https://developers.cloudflare.com/durable-objects/api/sqlite-storage-api/#tab-panel-4643)
- [Python](https://developers.cloudflare.com/durable-objects/api/sqlite-storage-api/#tab-panel-4644)
...
- [TypeScript](https://developers.cloudflare.com/durable-objects/api/sqlite-storage-api/#tab-panel-4645)
- [Python](https://developers.cloudflare.com/durable-objects/api/sqlite-storage-api/#tab-panel-4646)
...
- `limit`` number`
  - Maximum number of key-value pairs to return.
- `allowConcurrency`` boolean`
  - Same as the option to [`get()`](https://developers.cloudflare.com/durable-objects/api/sqlite-storage-api/#do-kv-async-get), above.
- `noCache`` boolean`
  - Same as the option to [`get()`](https://developers.cloudflare.com/durable-objects/api/sqlite-storage-api/#do-kv-async-get), above.
...
- Same options as [`get()`](https://developers.cloudflare.com/durable-objects/api/sqlite-storage-api/#get), but without `noCache`.
...
- `setAlarm()` and `deleteAlarm()` support the same options as [`put()`](https://developers.cloudflare.com/durable-objects/api/sqlite-storage-api/#put), but without `noCache`.
