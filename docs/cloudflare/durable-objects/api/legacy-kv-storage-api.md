...
[Skip to content](https://developers.cloudflare.com/durable-objects/api/legacy-kv-storage-api/#_top)
...
- [JavaScript](https://developers.cloudflare.com/durable-objects/api/legacy-kv-storage-api/#tab-panel-4633)
- [TypeScript](https://developers.cloudflare.com/durable-objects/api/legacy-kv-storage-api/#tab-panel-4634)
- [Python](https://developers.cloudflare.com/durable-objects/api/legacy-kv-storage-api/#tab-panel-4635)
...
- `allowConcurrency`` boolean`
  - Same as the option to [`get()`](https://developers.cloudflare.com/durable-objects/api/legacy-kv-storage-api/#do-kv-async-get), above.
- `noCache`` boolean`
  - Same as the option to [`get()`](https://developers.cloudflare.com/durable-objects/api/legacy-kv-storage-api/#do-kv-async-get), above.
...
- Same options as [`get()`](https://developers.cloudflare.com/durable-objects/api/legacy-kv-storage-api/#get), but without `noCache`.
...
- `setAlarm()` and `deleteAlarm()` support the same options as [`put()`](https://developers.cloudflare.com/durable-objects/api/legacy-kv-storage-api/#put), but without `noCache`.
