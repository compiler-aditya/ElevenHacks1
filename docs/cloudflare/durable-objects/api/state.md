...
[Skip to content](https://developers.cloudflare.com/durable-objects/api/state/#_top)
...
- [JavaScript](https://developers.cloudflare.com/durable-objects/api/state/#tab-panel-4650)
- [TypeScript](https://developers.cloudflare.com/durable-objects/api/state/#tab-panel-4651)
- [Python](https://developers.cloudflare.com/durable-objects/api/state/#tab-panel-4652)
...
- [JavaScript](https://developers.cloudflare.com/durable-objects/api/state/#tab-panel-4653)
- [Python](https://developers.cloudflare.com/durable-objects/api/state/#tab-panel-4654)
...
- [TypeScript](https://developers.cloudflare.com/durable-objects/api/state/#tab-panel-4655)
- [Python](https://developers.cloudflare.com/durable-objects/api/state/#tab-panel-4656)
