# Source: https://developers.cloudflare.com/durable-objects/release-notes/

[Skip to content](https://developers.cloudflare.com/durable-objects/release-notes/#_top)
