...
[Skip to content](https://developers.cloudflare.com/durable-objects/reference/durable-objects-migrations/#_top)
...
1. Add the following lines to your Wrangler configuration file:
   ...
   - [wrangler.jsonc](https://developers.cloudflare.com/durable-objects/reference/durable-objects-migrations/#tab-panel-4824)
   - [wrangler.toml](https://developers.cloudflare.com/durable-objects/reference/durable-objects-migrations/#tab-panel-4825)
...
- [wrangler.jsonc](https://developers.cloudflare.com/durable-objects/reference/durable-objects-migrations/#tab-panel-4830)
- [wrangler.toml](https://developers.cloudflare.com/durable-objects/reference/durable-objects-migrations/#tab-panel-4831)
...
- [wrangler.jsonc](https://developers.cloudflare.com/durable-objects/reference/durable-objects-migrations/#tab-panel-4826)
- [wrangler.toml](https://developers.cloudflare.com/durable-objects/reference/durable-objects-migrations/#tab-panel-4827)
...
3. Add the following lines to your Wrangler configuration file.
   ...
   - [wrangler.jsonc](https://developers.cloudflare.com/durable-objects/reference/durable-objects-migrations/#tab-panel-4828)
   - [wrangler.toml](https://developers.cloudflare.com/durable-objects/reference/durable-objects-migrations/#tab-panel-4829)
...
- [wrangler.jsonc](https://developers.cloudflare.com/durable-objects/reference/durable-objects-migrations/#tab-panel-4832)
- [wrangler.toml](https://developers.cloudflare.com/durable-objects/reference/durable-objects-migrations/#tab-panel-4833)
...
1. Update the previous class name to the new class name by editing your Wrangler configuration file in the following way:
   ...
   - [wrangler.jsonc](https://developers.cloudflare.com/durable-objects/reference/durable-objects-migrations/#tab-panel-4834)
   - [wrangler.toml](https://developers.cloudflare.com/durable-objects/reference/durable-objects-migrations/#tab-panel-4835)
...
- [wrangler.jsonc](https://developers.cloudflare.com/durable-objects/reference/durable-objects-migrations/#tab-panel-4836)
- [wrangler.toml](https://developers.cloudflare.com/durable-objects/reference/durable-objects-migrations/#tab-panel-4837)
...
If you want to transfer stored Durable Objects between two Durable Object classes in the same Worker code file, use [Rename migrations](https://developers.cloudflare.com/durable-objects/reference/durable-objects-migrations/#rename-migration) instead.
...
1. Edit your Wrangler configuration file in the following way:
   ...
   - [wrangler.jsonc](https://developers.cloudflare.com/durable-objects/reference/durable-objects-migrations/#tab-panel-4838)
   - [wrangler.toml](https://developers.cloudflare.com/durable-objects/reference/durable-objects-migrations/#tab-panel-4839)
...
- [wrangler.jsonc](https://developers.cloudflare.com/durable-objects/reference/durable-objects-migrations/#tab-panel-4840)
- [wrangler.toml](https://developers.cloudflare.com/durable-objects/reference/durable-objects-migrations/#tab-panel-4841)
