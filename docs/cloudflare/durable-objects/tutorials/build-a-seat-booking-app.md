# Source: https://developers.cloudflare.com/durable-objects/tutorials/build-a-seat-booking-app/

[Skip to content](https://developers.cloudflare.com/durable-objects/tutorials/build-a-seat-booking-app/#_top)
...
1. Create a Worker named `seat-booking` by running:
   ...
   - [npm](https://developers.cloudflare.com/durable-objects/tutorials/build-a-seat-booking-app/#tab-panel-4850)
   - [yarn](https://developers.cloudflare.com/durable-objects/tutorials/build-a-seat-booking-app/#tab-panel-4851)
   - [pnpm](https://developers.cloudflare.com/durable-objects/tutorials/build-a-seat-booking-app/#tab-panel-4852)
...
- [wrangler.jsonc](https://developers.cloudflare.com/durable-objects/tutorials/build-a-seat-booking-app/#tab-panel-4853)
- [wrangler.toml](https://developers.cloudflare.com/durable-objects/tutorials/build-a-seat-booking-app/#tab-panel-4854)
...
- [wrangler.jsonc](https://developers.cloudflare.com/durable-objects/tutorials/build-a-seat-booking-app/#tab-panel-4855)
- [wrangler.toml](https://developers.cloudflare.com/durable-objects/tutorials/build-a-seat-booking-app/#tab-panel-4856)
...
3. Add a `fetch` handler to the `Flight` class. This handler will return a text response. In [Step 5](https://developers.cloudflare.com/durable-objects/tutorials/build-a-seat-booking-app/#5-handle-websocket-connections) You will update the `fetch` handler to handle the WebSocket connection.
