# Source: https://developers.cloudflare.com/durable-objects/examples/alarms-api/

[Skip to content](https://developers.cloudflare.com/durable-objects/examples/alarms-api/#_top)
...
- [JavaScript](https://developers.cloudflare.com/durable-objects/examples/alarms-api/#tab-panel-4746)
- [Python](https://developers.cloudflare.com/durable-objects/examples/alarms-api/#tab-panel-4747)
...
- [wrangler.jsonc](https://developers.cloudflare.com/durable-objects/examples/alarms-api/#tab-panel-4748)
- [wrangler.toml](https://developers.cloudflare.com/durable-objects/examples/alarms-api/#tab-panel-4749)
