# Source: https://developers.cloudflare.com/workers/prompts/pages-to-workers.txt
...
\- Replace \`pages\_build\_output\_dir\` with \`"assets": {"directory": "path"}\`
\- Ensure a \`compatibility\_date\` field exists
...
{
 "name": "project-name",
 "compatibility\_date": "2025-06-05",
...
\- Use: \`wrangler pages functions build --outdir=/\_worker.js/\`
