# Source: https://developers.cloudflare.com/workers/examples/debugging-logs/

[Skip to content](https://developers.cloudflare.com/workers/examples/debugging-logs/#_top)
...
- [JavaScript](https://developers.cloudflare.com/workers/examples/debugging-logs/#tab-panel-8119)
- [TypeScript](https://developers.cloudflare.com/workers/examples/debugging-logs/#tab-panel-8120)
- [Python](https://developers.cloudflare.com/workers/examples/debugging-logs/#tab-panel-8121)
- [Hono](https://developers.cloudflare.com/workers/examples/debugging-logs/#tab-panel-8122)
