# Source: https://developers.cloudflare.com/workers/examples/security-headers/

[Skip to content](https://developers.cloudflare.com/workers/examples/security-headers/#_top)
...
- [JavaScript](https://developers.cloudflare.com/workers/examples/security-headers/#tab-panel-8211)
- [TypeScript](https://developers.cloudflare.com/workers/examples/security-headers/#tab-panel-8212)
- [Python](https://developers.cloudflare.com/workers/examples/security-headers/#tab-panel-8213)
- [Rust](https://developers.cloudflare.com/workers/examples/security-headers/#tab-panel-8214)
- [Hono](https://developers.cloudflare.com/workers/examples/security-headers/#tab-panel-8215)
