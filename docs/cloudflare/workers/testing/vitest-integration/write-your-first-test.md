...
[Skip to content](https://developers.cloudflare.com/workers/testing/vitest-integration/write-your-first-test/#_top)
...
- Vitest and `@cloudflare/vitest-pool-workers` are installed in your project as dev dependencies
  ...
  - [npm](https://developers.cloudflare.com/workers/testing/vitest-integration/write-your-first-test/#tab-panel-9010)
  - [yarn](https://developers.cloudflare.com/workers/testing/vitest-integration/write-your-first-test/#tab-panel-9011)
  - [pnpm](https://developers.cloudflare.com/workers/testing/vitest-integration/write-your-first-test/#tab-panel-9012)
...
- [JavaScript](https://developers.cloudflare.com/workers/testing/vitest-integration/write-your-first-test/#tab-panel-9013)
- [TypeScript](https://developers.cloudflare.com/workers/testing/vitest-integration/write-your-first-test/#tab-panel-9014)
...
- [JavaScript](https://developers.cloudflare.com/workers/testing/vitest-integration/write-your-first-test/#tab-panel-9017)
- [TypeScript](https://developers.cloudflare.com/workers/testing/vitest-integration/write-your-first-test/#tab-panel-9018)
...
- [JavaScript](https://developers.cloudflare.com/workers/testing/vitest-integration/write-your-first-test/#tab-panel-9015)
- [TypeScript](https://developers.cloudflare.com/workers/testing/vitest-integration/write-your-first-test/#tab-panel-9016)
