...
[Skip to content](https://developers.cloudflare.com/workers/platform/limits/#_top)
...
| --- | --- | --- |
| [Requests](https://developers.cloudflare.com/workers/platform/limits/#daily-requests) | 100,000/day | No limit |
| [CPU time](https://developers.cloudflare.com/workers/platform/limits/#cpu-time) | 10 ms | 5 min |
| [Memory](https://developers.cloudflare.com/workers/platform/limits/#memory) | 128 MB | 128 MB |
| [Subrequests](https://developers.cloudflare.com/workers/platform/limits/#subrequests) | 50/request | 10,000/request |
| [Simultaneous outgoing\<br>\<br>connections/request](https://developers.cloudflare.com/workers/platform/limits/#simultaneous-open-connections) | 6 | 6 |
| [Environment variables](https://developers.cloudflare.com/workers/platform/limits/#environment-variables) | 64/Worker | 128/Worker |
| [Environment variable\<br>\<br>size](https://developers.cloudflare.com/workers/platform/limits/#environment-variables) | 5 KB | 5 KB |
| [Worker size](https://developers.cloudflare.com/workers/platform/limits/#worker-size) | 3 MB | 10 MB |
| [Worker startup time](https://developers.cloudflare.com/workers/platform/limits/#worker-startup-time) | 1 second | 1 second |
| [Number of Workers](https://developers.cloudflare.com/workers/platform/limits/#number-of-workers) 1 | 100 | 500 |
| Number of [Cron Triggers](https://developers.cloudflare.com/workers/configuration/cron-triggers/)<br>per account | 5 | 250 |
| Number of [Static Asset](https://developers.cloudflare.com/workers/platform/limits/#static-assets) files per Worker version | 20,000 | 100,000 |
| Individual [Static Asset](https://developers.cloudflare.com/workers/platform/limits/#static-assets) file size | 25 MiB | 25 MiB |
...
- [wrangler.jsonc](https://developers.cloudflare.com/workers/platform/limits/#tab-panel-8738)
- [wrangler.toml](https://developers.cloudflare.com/workers/platform/limits/#tab-panel-8739)
...
| Routes per zone ( [`wrangler dev --remote`](https://developers.cloudflare.com/workers/platform/limits/#routes-remote-dev)) | 50 |
