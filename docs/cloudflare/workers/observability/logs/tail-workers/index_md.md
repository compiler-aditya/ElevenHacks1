...
!\[Tail Worker diagram\](https://developers.cloudflare.com/\_astro/tail-workers.CaYo-ajt\_1Mwmpt.webp)
...
\\* \[ wrangler.jsonc \](#tab-panel-8702)
\\* \[ wrangler.toml \](#tab-panel-8703)
...
Workers added to the \`tail\_consumers\` array must have a \`tail()\` handler defined.
