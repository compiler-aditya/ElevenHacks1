# Source: https://developers.cloudflare.com/agents/api-reference/get-current-agent/

[Skip to content](https://developers.cloudflare.com/agents/api-reference/get-current-agent/#_top)
...
- [JavaScript](https://developers.cloudflare.com/agents/api-reference/get-current-agent/#tab-panel-2503)
- [TypeScript](https://developers.cloudflare.com/agents/api-reference/get-current-agent/#tab-panel-2504)
...
- [JavaScript](https://developers.cloudflare.com/agents/api-reference/get-current-agent/#tab-panel-2519)
- [TypeScript](https://developers.cloudflare.com/agents/api-reference/get-current-agent/#tab-panel-2520)
...
- [JavaScript](https://developers.cloudflare.com/agents/api-reference/get-current-agent/#tab-panel-2501)
- [TypeScript](https://developers.cloudflare.com/agents/api-reference/get-current-agent/#tab-panel-2502)
...
- [JavaScript](https://developers.cloudflare.com/agents/api-reference/get-current-agent/#tab-panel-2513)
- [TypeScript](https://developers.cloudflare.com/agents/api-reference/get-current-agent/#tab-panel-2514)
...
- [JavaScript](https://developers.cloudflare.com/agents/api-reference/get-current-agent/#tab-panel-2511)
- [TypeScript](https://developers.cloudflare.com/agents/api-reference/get-current-agent/#tab-panel-2512)
...
- [JavaScript](https://developers.cloudflare.com/agents/api-reference/get-current-agent/#tab-panel-2515)
- [TypeScript](https://developers.cloudflare.com/agents/api-reference/get-current-agent/#tab-panel-2516)
...
- [JavaScript](https://developers.cloudflare.com/agents/api-reference/get-current-agent/#tab-panel-2505)
- [TypeScript](https://developers.cloudflare.com/agents/api-reference/get-current-agent/#tab-panel-2506)
...
- [JavaScript](https://developers.cloudflare.com/agents/api-reference/get-current-agent/#tab-panel-2517)
- [TypeScript](https://developers.cloudflare.com/agents/api-reference/get-current-agent/#tab-panel-2518)
...
3. **Check for undefined**: The returned values may be `undefined` if called outside an agent context.
   ...
   - [JavaScript](https://developers.cloudflare.com/agents/api-reference/get-current-agent/#tab-panel-2509)
   - [TypeScript](https://developers.cloudflare.com/agents/api-reference/get-current-agent/#tab-panel-2510)
...
4. **Type the agent**: Pass your agent class as a type parameter for proper typing.
   ...
   - [JavaScript](https://developers.cloudflare.com/agents/api-reference/get-current-agent/#tab-panel-2507)
   - [TypeScript](https://developers.cloudflare.com/agents/api-reference/get-current-agent/#tab-panel-2508)
