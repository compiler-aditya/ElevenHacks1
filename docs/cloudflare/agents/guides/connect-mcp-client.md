# Source: https://developers.cloudflare.com/agents/guides/connect-mcp-client/

[Skip to content](https://developers.cloudflare.com/agents/guides/connect-mcp-client/#_top)
...
1. Create a new Agent project using the `hello-world` template:
   ...
   - [npm](https://developers.cloudflare.com/agents/guides/connect-mcp-client/#tab-panel-3041)
   - [yarn](https://developers.cloudflare.com/agents/guides/connect-mcp-client/#tab-panel-3042)
   - [pnpm](https://developers.cloudflare.com/agents/guides/connect-mcp-client/#tab-panel-3043)
...
Your Agent is ready! The template includes a minimal Agent in `src/index.ts`:
   ...
   - [JavaScript](https://developers.cloudflare.com/agents/guides/connect-mcp-client/#tab-panel-3044)
   - [TypeScript](https://developers.cloudflare.com/agents/guides/connect-mcp-client/#tab-panel-3045)
...
1. Add an endpoint to connect to MCP servers. Update your Agent class in `src/index.ts`:
   ...
   - [JavaScript](https://developers.cloudflare.com/agents/guides/connect-mcp-client/#tab-panel-3048)
   - [TypeScript](https://developers.cloudflare.com/agents/guides/connect-mcp-client/#tab-panel-3049)
...
1. Add an endpoint to see which tools are available from connected servers:
   ...
   - [JavaScript](https://developers.cloudflare.com/agents/guides/connect-mcp-client/#tab-panel-3046)
   - [TypeScript](https://developers.cloudflare.com/agents/guides/connect-mcp-client/#tab-panel-3047)
