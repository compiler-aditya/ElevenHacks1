...
[Skip to content](https://developers.cloudflare.com/agents/concepts/agent-class/#_top)
...
The `Agent` class re-exports the [addressing helpers](https://developers.cloudflare.com/agents/concepts/agent-class/#addressing) as `getAgentByName` and `routeAgentRequest`.
