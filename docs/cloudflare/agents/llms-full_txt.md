# Source: https://developers.cloudflare.com/agents/llms-full.txt
...
function Counter() {
 ...
 return  agent.stub.increment()}>{count};
...
\\* \[ JavaScript \](#tab-panel-2221)
\\* \[ TypeScript \](#tab-panel-2222)
...
\\* \[ wrangler.jsonc \](#tab-panel-2991)
\\* \[ wrangler.toml \](#tab-panel-2992)
...
\
 "tag": "v1",\
\
 "new\_sqlite\_classes": \["CounterAgent"\],\
\
 },\
\
 \],
...
\\* \`class\_name\` must exactly match your exported class name
\\* \`new\_sqlite\_classes\` enables SQLite storage for state persistence
\\* \`nodejs\_compat\` flag is required for the agents package
...
\\* \[ wrangler.jsonc \](#tab-panel-2983)
\\* \[ wrangler.toml \](#tab-panel-2984)
...
function CounterWidget() {
 ...
 {count}
  ...
  agent.stub.increment()}>+ agent.stub.decrement()}>-
...
\\* \[ wrangler.jsonc \](#tab-panel-2989)
\\* \[ wrangler.toml \](#tab-panel-2990)
...

{
 ...
 "bindings": \[\
\
 { "name": "CounterAgent", "class\_name": "CounterAgent" },\
\
 { "name": "Chat", "class\_name": "Chat" },\
\
 { "name": "Scheduler", "class\_name": "Scheduler" },\
\
 \],
...
\
 "tag": "v1",\
\
 "new\_sqlite\_classes": \["CounterAgent", "Chat", "Scheduler"\],\
\
 },\
\
 \],
...
\\* \[ JavaScript \](#tab-panel-2995)
\\* \[ TypeScript \](#tab-panel-2996)
...
2\. \*\*Check the binding\*\* \\- \`class\_name\` in the Wrangler configuration file must exactly match the exported class name.
...
\\* \[ wrangler.jsonc \](#tab-panel-2985)
\\* \[ wrangler.toml \](#tab-panel-2986)
...
\
 "tag": "v1",\
\
 "new\_sqlite\_classes": \["YourAgentClass"\],\
\
 },\
\
 \],
...
2\. The agent class is in \`new\_sqlite\_classes\` in migrations.
...
\\* \[ wrangler.jsonc \](#tab-panel-3026)
\\* \[ wrangler.toml \](#tab-panel-3027)
...
agent.stub.decrement()}>- agent.stub.reset()}>Reset agent.stub.increment()}>+
...
!\[Figure 1: Prompt Chaining\](https://developers.cloudflare.com/\_astro/01-prompt-chaining.BLijYLLo\_Z4mjQb.webp)
...
!\[Figure 2: Routing\](https://developers.cloudflare.com/\_astro/2\_Routing.CT-Tgwab\_1YYXmR.webp)
...
!\[Figure 3: Parallelization\](https://developers.cloudflare.com/\_astro/3\_Parallelization.gkwf-xnL\_1psyLV.webp)
...
!\[Figure 4: Orchestrator Workers\](https://developers.cloudflare.com/\_astro/4\_Orchestrator-Workers.jVghtZEj\_Z6FePI.webp)
...
!\[Figure 5: Evaluator-Optimizer\](https://developers.cloudflare.com/\_astro/5\_Evaluator-Optimizer.uXTWfJxj\_Z8n6xm.webp)
...

{
 ...
 "PAY\_TO": "0xYourWalletAddress",

 "TEMPO\_TESTNET": false,

 "PAYMENT\_CURRENCY": "0x20c000000000000000000000b9537d11c60e8b50",
...
Set \`TEMPO\_TESTNET\` to \`true\` and \`PAYMENT\_CURRENCY\` to \`0x20c0000000000000000000000000000000000000\` for testnet development.
...

{
 ...
 "bot\_score\_threshold": 30,

 "except\_detection\_ids": \[120623194, 117479730\]

}

\`\`\`

Requests with a bot score at or below \`bot\_score\_threshold\` are directed to the paywall. Use \`except\_detection\_ids\` to allowlist specific crawlers by \[detection ID\](https://developers.cloudflare.com/ai-crawl-control/reference/bots/).
...
npx wrangler secret put JWT\_SECRET

npx wrangler secret put MPP\_SECRET\_KEY
...

{
 ...
 "except\_detection\_ids": \[117479730\]

}

\`\`\`

Requests with a bot score below \`bot\_score\_threshold\` are directed to the paywall. Use \`except\_detection\_ids\` to allowlist specific crawlers by \[detection ID\](https://developers.cloudflare.com/ai-crawl-control/reference/bots/).
...
export class MyAgent extends Agent {
 ...
 const { id } = await this.mcp.connect(\`${this.env.WORKER\_URL}/mcp\`);

 const account = privateKeyToAccount(this.env.MY\_PRIVATE\_KEY);
...
npx wrangler secret put MY\_PRIVATE\_KEY
...
\\* A wallet private key (set as \`X402\_PRIVATE\_KEY\` environment variable)
...
export const X402PaymentPlugin: Plugin = async () => ({
 ...
 const privateKey = process.env.X402\_PRIVATE\_KEY;

 if (!privateKey) {

 throw new Error("X402\_PRIVATE\_KEY environment variable is not set.");
...
const haystack = JSON.stringify(input.tool\_response ?? input.error ?? "");

if (!haystack.includes("402")) process.exit(0);

const url = input.tool\_input?.url;
...
if (!privateKey) {
 ...
 console.error("X402\_PRIVATE\_KEY not set.");
...
\\* \[ wrangler.jsonc \](#tab-panel-2229)
\\* \[ wrangler.toml \](#tab-panel-2230)
...
npx wrangler@latest secret put BROWSERBASE\_API\_KEY
...
Success! Uploaded secret BROWSERBASE\_API\_KEY
...
\\* \[ JavaScript \](#tab-panel-2231)
\\* \[ TypeScript \](#tab-panel-2232)
...
\\* \[ JavaScript \](#tab-panel-2235)
\\* \[ TypeScript \](#tab-panel-2236)
...
\\* \[ JavaScript \](#tab-panel-2247)
\\* \[ TypeScript \](#tab-panel-2248)
...
\\* \[ JavaScript \](#tab-panel-2243)
\\* \[ TypeScript \](#tab-panel-2244)
...
\\* \[ JavaScript \](#tab-panel-2265)
\\* \[ TypeScript \](#tab-panel-2266)
...
\\* \[ JavaScript \](#tab-panel-2263)
\\* \[ TypeScript \](#tab-panel-2264)
...
\\* \[ JavaScript \](#tab-panel-2269)
\\* \[ TypeScript \](#tab-panel-2270)
...
\\* \[ JavaScript \](#tab-panel-2259)
\\* \[ TypeScript \](#tab-panel-2260)
...
\\* \[ JavaScript \](#tab-panel-2261)
\\* \[ TypeScript \](#tab-panel-2262)
...
\\* \[ JavaScript \](#tab-panel-2277)
\\* \[ TypeScript \](#tab-panel-2278)
...
\\* \[ JavaScript \](#tab-panel-2273)
\\* \[ TypeScript \](#tab-panel-2274)
...
\\* \[ JavaScript \](#tab-panel-2279)
\\* \[ TypeScript \](#tab-panel-2280)
...
\\* \[ JavaScript \](#tab-panel-2281)
\\* \[ TypeScript \](#tab-panel-2282)
...
\\* \[ JavaScript \](#tab-panel-2309)
\\* \[ TypeScript \](#tab-panel-2310)
...
The \`new\_sqlite\_classes\` migration is required — \`AIChatAgent\` uses SQLite for message persistence and stream chunk buffering.
...
sequenceDiagram
 ...
 Client->>Agent: CF\_AGENT\_USE\_CHAT\_REQUEST (WebSocket)
 Agent->>DB: Persist messages
 Agent->>Agent: onChatMessage()
 loop Streaming response
 Agent-->>Client: CF\_AGENT\_USE\_CHAT\_RESPONSE (chunks)
 Agent->>DB: Buffer chunks
 end
 Agent->>DB: Persist final message
 Agent-->>Client: CF\_AGENT\_CHAT\_MESSAGES (broadcast to all clients)
...
\\* \[ JavaScript \](#tab-panel-2287)
\\* \[ TypeScript \](#tab-panel-2288)
...
\\* \[ JavaScript \](#tab-panel-2299)
\\* \[ TypeScript \](#tab-panel-2300)
...
\\* \[ JavaScript \](#tab-panel-2297)
\\* \[ TypeScript \](#tab-panel-2298)
...
export class ChatAgent extends AIChatAgent {
 ...
 // waitForMcpConnections = { timeout: 10\_000 };
...
\\* \[ JavaScript \](#tab-panel-2293)
\\* \[ TypeScript \](#tab-panel-2294)
...
\\* \[ JavaScript \](#tab-panel-2301)
\\* \[ TypeScript \](#tab-panel-2302)
...
When a user clicks "stop" in the chat UI, the client sends a \`CF\_AGENT\_CHAT\_REQUEST\_CANCEL\` message. The server propagates this to the \`abortSignal\` in \`options\`:

\\* \[ JavaScript \](#tab-panel-2303)
\\* \[ TypeScript \](#tab-panel-2304)
...
\\* \[ JavaScript \](#tab-panel-2307)
\\* \[ TypeScript \](#tab-panel-2308)
...
\\* \[ JavaScript \](#tab-panel-2323)
\\* \[ TypeScript \](#tab-panel-2324)
...
\\* \[ JavaScript \](#tab-panel-2305)
\\* \[ TypeScript \](#tab-panel-2306)
...
\\* \[ JavaScript \](#tab-panel-2313)
\\* \[ TypeScript \](#tab-panel-2314)
...
\\* \[ JavaScript \](#tab-panel-2311)
\\* \[ TypeScript \](#tab-panel-2312)
...
\\* \[ JavaScript \](#tab-panel-2341)
\\* \[ TypeScript \](#tab-panel-2342)
...
This sends a \`tool\_result\` to the LLM with your custom error text, so it can respond appropriately (for example, suggest an alternative or ask clarifying questions).
...
\\* \[ JavaScript \](#tab-panel-2319)
\\* \[ TypeScript \](#tab-panel-2320)
...
\\* \[ JavaScript \](#tab-panel-2317)
\\* \[ TypeScript \](#tab-panel-2318)
...
\\* \[ JavaScript \](#tab-panel-2321)
\\* \[ TypeScript \](#tab-panel-2322)
...
\\* \[ JavaScript \](#tab-panel-2347)
\\* \[ TypeScript \](#tab-panel-2348)
...
\\* \[ JavaScript \](#tab-panel-2331)
\\* \[ TypeScript \](#tab-panel-2332)
...
\\* \[ JavaScript \](#tab-panel-2329)
\\* \[ TypeScript \](#tab-panel-2330)
...
\\* \[ JavaScript \](#tab-panel-2327)
\\* \[ TypeScript \](#tab-panel-2328)
...
\\* \[ JavaScript \](#tab-panel-2343)
\\* \[ TypeScript \](#tab-panel-2344)
...
\\* \[ JavaScript \](#tab-panel-2333)
\\* \[ TypeScript \](#tab-panel-2334)
...
\\* \[ JavaScript \](#tab-panel-2335)
\\* \[ TypeScript \](#tab-panel-2336)
...
\\* \[ JavaScript \](#tab-panel-2339)
\\* \[ TypeScript \](#tab-panel-2340)
...
const anthropic = createAnthropic({ apiKey: this.env.ANTHROPIC\_API\_KEY });
...
\\* \[ JavaScript \](#tab-panel-2351)
\\* \[ TypeScript \](#tab-panel-2352)
...
\\* \[ JavaScript \](#tab-panel-2349)
\\* \[ TypeScript \](#tab-panel-2350)
...
\\* \[ JavaScript \](#tab-panel-2353)
\\* \[ TypeScript \](#tab-panel-2354)
...
\\* \[ JavaScript \](#tab-panel-2355)
\\* \[ TypeScript \](#tab-panel-2356)
...
\\* \[ JavaScript \](#tab-panel-2345)
\\* \[ TypeScript \](#tab-panel-2346)
...
Client A ◀── CF\_AGENT\_USE\_CHAT\_RESPONSE ──────┤

Client B ◀── CF\_AGENT\_CHAT\_MESSAGES ──────────┘

\`\`\`

The originating client receives the streaming response. All other clients receive the final messages via a \`CF\_AGENT\_CHAT\_MESSAGES\` broadcast.
...
\\* \[ JavaScript \](#tab-panel-2361)
\\* \[ TypeScript \](#tab-panel-2362)
...
useAgent({ agent: "LOUD\_AGENT" }); // → /agents/loud-agent/...
...
\\* \[ JavaScript \](#tab-panel-2359)
\\* \[ TypeScript \](#tab-panel-2360)
...
\\* \[ JavaScript \](#tab-panel-2375)
\\* \[ TypeScript \](#tab-panel-2376)
...
\\* \[ JavaScript \](#tab-panel-2371)
\\* \[ TypeScript \](#tab-panel-2372)
...
\\* \[ JavaScript \](#tab-panel-2363)
\\* \[ TypeScript \](#tab-panel-2364)
...
\\* \[ JavaScript \](#tab-panel-2369)
\\* \[ TypeScript \](#tab-panel-2370)
...
\\* \[ JavaScript \](#tab-panel-2395)
\\* \[ TypeScript \](#tab-panel-2396)
...
\\* \[ JavaScript \](#tab-panel-2397)
\\* \[ TypeScript \](#tab-panel-2398)
...
\\* \[ JavaScript \](#tab-panel-2381)
\\* \[ TypeScript \](#tab-panel-2382)
...
\\* \[ JavaScript \](#tab-panel-2383)
\\* \[ TypeScript \](#tab-panel-2384)
...
\\* \[ JavaScript \](#tab-panel-2379)
\\* \[ TypeScript \](#tab-panel-2380)
...
\\* \[ JavaScript \](#tab-panel-2385)
\\* \[ TypeScript \](#tab-panel-2386)
...
\\* \[ JavaScript \](#tab-panel-2387)
\\* \[ TypeScript \](#tab-panel-2388)
...
\\* \[ JavaScript \](#tab-panel-2389)
\\* \[ TypeScript \](#tab-panel-2390)
...
\\* \[ JavaScript \](#tab-panel-2391)
\\* \[ TypeScript \](#tab-panel-2392)
...
\\* \[ JavaScript \](#tab-panel-2393)
\\* \[ TypeScript \](#tab-panel-2394)
...
\\* \[ JavaScript \](#tab-panel-2411)
\\* \[ TypeScript \](#tab-panel-2412)
...
\\* \[ JavaScript \](#tab-panel-2401)
\\* \[ TypeScript \](#tab-panel-2402)
...
\\* \[ JavaScript \](#tab-panel-2405)
\\* \[ TypeScript \](#tab-panel-2406)
...
Add a \`worker\_loaders\` binding to your \`wrangler.jsonc\`. This is the only binding required:

\\* \[ wrangler.jsonc \](#tab-panel-2399)
\\* \[ wrangler.toml \](#tab-panel-2400)
...
worker\_loaders = \[{ binding = "LOADER" }\]
...
const executor = new DynamicWorkerExecutor({
 ...
 // globalOutbound: env.MY\_OUTBOUND\_SERVICE // route through a Fetcher
...
\\* \[ JavaScript \](#tab-panel-2421)
\\* \[ TypeScript \](#tab-panel-2422)
...
\\* \[ JavaScript \](#tab-panel-2407)
\\* \[ TypeScript \](#tab-panel-2408)
...
Tool names with hyphens or dots (common in MCP) are automatically sanitized to valid JavaScript identifiers (for example, \`my-server.list-items\` becomes \`my\_server\_list\_items\`).
...
\\* \[ JavaScript \](#tab-panel-2409)
\\* \[ TypeScript \](#tab-panel-2410)
...
\\* \[ JavaScript \](#tab-panel-2419)
\\* \[ TypeScript \](#tab-panel-2420)
...
\| modules \| Record \| — \| Custom ES modules available in the sandbox. Keys are specifiers, values are source. \|
...
\\* \[ JavaScript \](#tab-panel-2415)
\\* \[ TypeScript \](#tab-panel-2416)
...
\\* \[ JavaScript \](#tab-panel-2417)
\\* \[ TypeScript \](#tab-panel-2418)
...
sanitizeToolName("get-weather"); // "get\_weather"

sanitizeToolName("3d-render"); // "\_3d\_render"

sanitizeToolName("delete"); // "delete\_"
...
\\* \[ JavaScript \](#tab-panel-2483)
\\* \[ TypeScript \](#tab-panel-2484)
...
\\* \[ JavaScript \](#tab-panel-2473)
\\* \[ TypeScript \](#tab-panel-2474)
...
const resolver = createSecureReplyEmailResolver(env.EMAIL\_SECRET);
...
\\* \[ JavaScript \](#tab-panel-2479)
\\* \[ TypeScript \](#tab-panel-2480)
...
const resolver = createSecureReplyEmailResolver(env.EMAIL\_SECRET, {
 ...
 // reason can be: "missing\_headers", "expired", "invalid", "malformed\_timestamp"
...
\\* \[ JavaScript \](#tab-panel-2477)
\\* \[ TypeScript \](#tab-panel-2478)
...
\\* \[ JavaScript \](#tab-panel-2485)
\\* \[ TypeScript \](#tab-panel-2486)
...
\\* \[ JavaScript \](#tab-panel-2489)
\\* \[ TypeScript \](#tab-panel-2490)
...
\\* \[ JavaScript \](#tab-panel-2491)
\\* \[ TypeScript \](#tab-panel-2492)
...
class MyAgent extends Agent {
 ...
 secret: this.env.EMAIL\_SECRET, // Optional, signs headers for secure reply routing
...
\\* \[ JavaScript \](#tab-panel-2481)
\\* \[ TypeScript \](#tab-panel-2482)
...
\\* \[ JavaScript \](#tab-panel-2487)
\\* \[ TypeScript \](#tab-panel-2488)
...
1\. Add a secret to your \`wrangler.jsonc\`:
 \\* \[ wrangler.jsonc \](#tab-panel-2471)
 \\* \[ wrangler.toml \](#tab-panel-2472)
\`\`\`
{
 "vars": {
 "EMAIL\_SECRET": "change-me-in-production",
 },
}
\`\`\`
\`\`\`
...
Terminal window
\`\`\`
npx wrangler secret put EMAIL\_SECRET
\`\`\`
2\. Use the combined resolver pattern:
 \\* \[ JavaScript \](#tab-panel-2497)
 \\* \[ TypeScript \](#tab-panel-2498)
JavaScript
\`\`\`
export default {
 async email(message, env) {
...
3\. Sign outbound emails:
 \\* \[ JavaScript \](#tab-panel-2493)
 \\* \[ TypeScript \](#tab-panel-2494)
JavaScript
\`\`\`
class MyAgent extends Agent {
 async onEmail(email) {
 ...
 fromName: "My Agent",
 body: "Thanks for your email!",
 secret: this.env.EMAIL\_SECRET, // Signs the routing headers
 });
 }
}
\`\`\`
...
\\* \[ JavaScript \](#tab-panel-2499)
\\* \[ TypeScript \](#tab-panel-2500)
...
\\* \[ JavaScript \](#tab-panel-2503)
\\* \[ TypeScript \](#tab-panel-2504)
...
\\* \[ JavaScript \](#tab-panel-2519)
\\* \[ TypeScript \](#tab-panel-2520)
...
\\* \[ JavaScript \](#tab-panel-2501)
\\* \[ TypeScript \](#tab-panel-2502)
...
\\* \[ JavaScript \](#tab-panel-2505)
\\* \[ TypeScript \](#tab-panel-2506)
...
\\* \[ JavaScript \](#tab-panel-2517)
\\* \[ TypeScript \](#tab-panel-2518)
...
3\. \*\*Check for undefined\*\*: The returned values may be \`undefined\` if called outside an agent context.
 \\* \[ JavaScript \](#tab-panel-2509)
 \\* \[ TypeScript \](#tab-panel-2510)
JavaScript
\`\`\`
const { agent } = getCurrentAgent();
if (agent) {
...
4\. \*\*Type the agent\*\*: Pass your agent class as a type parameter for proper typing.
 \\* \[ JavaScript \](#tab-panel-2507)
 \\* \[ TypeScript \](#tab-panel-2508)
JavaScript
\`\`\`
const { agent } = getCurrentAgent();
...
\\* \[ JavaScript \](#tab-panel-2523)
\\* \[ TypeScript \](#tab-panel-2524)
...
\\* \[ JavaScript \](#tab-panel-2527)
\\* \[ TypeScript \](#tab-panel-2528)
...
\\* \[ JavaScript \](#tab-panel-2521)
\\* \[ TypeScript \](#tab-panel-2522)
...
\\* \[ JavaScript \](#tab-panel-2525)
\\* \[ TypeScript \](#tab-panel-2526)
...
\\* \[ JavaScript \](#tab-panel-2537)
\\* \[ TypeScript \](#tab-panel-2538)
...
\\* \[ JavaScript \](#tab-panel-2529)
\\* \[ TypeScript \](#tab-panel-2530)
...
\\* \[ JavaScript \](#tab-panel-2533)
\\* \[ TypeScript \](#tab-panel-2534)
...
\\* \[ JavaScript \](#tab-panel-2551)
\\* \[ TypeScript \](#tab-panel-2552)
...
\\* \[ JavaScript \](#tab-panel-2547)
\\* \[ TypeScript \](#tab-panel-2548)
...
\\* \[ JavaScript \](#tab-panel-2555)
\\* \[ TypeScript \](#tab-panel-2556)
...
\\* \[ JavaScript \](#tab-panel-2575)
\\* \[ TypeScript \](#tab-panel-2576)
...
\\* \[ JavaScript \](#tab-panel-2565)
\\* \[ TypeScript \](#tab-panel-2566)
...
\\* \[ JavaScript \](#tab-panel-2553)
\\* \[ TypeScript \](#tab-panel-2554)
...
\\* \[ JavaScript \](#tab-panel-2561)
\\* \[ TypeScript \](#tab-panel-2562)
...
\\* \[ JavaScript \](#tab-panel-2559)
\\* \[ TypeScript \](#tab-panel-2560)
...
\\* \[ JavaScript \](#tab-panel-2567)
\\* \[ TypeScript \](#tab-panel-2568)
...
\\* \[ JavaScript \](#tab-panel-2557)
\\* \[ TypeScript \](#tab-panel-2558)
...
\\* \[ JavaScript \](#tab-panel-2563)
\\* \[ TypeScript \](#tab-panel-2564)
...
for (const \[id, server\] of Object.entries(state.servers)) {
 ...
 console.log(\`${id}: ${server.name} (${server.server\_url})\`);
...
\\* \[ JavaScript \](#tab-panel-2581)
\\* \[ TypeScript \](#tab-panel-2582)
...
\\* \[ JavaScript \](#tab-panel-2573)
\\* \[ TypeScript \](#tab-panel-2574)
...
\\* \[ JavaScript \](#tab-panel-2579)
\\* \[ TypeScript \](#tab-panel-2580)
...
export class MyAgent extends Agent {
 ...
 client\_id: env.MCP\_CLIENT\_ID,

 client\_secret: env.MCP\_CLIENT\_SECRET,

 redirect\_uris: \[callbackUrl\],
...
\\* \[ JavaScript \](#tab-panel-2583)
\\* \[ TypeScript \](#tab-panel-2584)
...
\\* \[ JavaScript \](#tab-panel-2571)
\\* \[ TypeScript \](#tab-panel-2572)
...
MCP server list broadcasts (\`cf\_agent\_mcp\_servers\`) are automatically filtered to exclude connections where \[shouldSendProtocolMessages\](https://developers.cloudflare.com/agents/api-reference/protocol-messages/) returned \`false\`.
...
await this.mcp.waitForConnections({ timeout: 10\_000 });

\`\`\`

Note

\`AIChatAgent\` calls this automatically via its \[waitForMcpConnections\](https://developers.cloudflare.com/agents/api-reference/chat-agents/#waitformcpconnections) property (defaults to \`{ timeout: 10\_000 }\`). You only need \`waitForConnections()\` directly when using \`Agent\` with MCP, or when you want finer control inside \`onChatMessage\`.
...
\\* \[ JavaScript \](#tab-panel-2577)
\\* \[ TypeScript \](#tab-panel-2578)
...
\\* \[ JavaScript \](#tab-panel-2585)
\\* \[ TypeScript \](#tab-panel-2586)
...
\\* \[ JavaScript \](#tab-panel-2607)
\\* \[ TypeScript \](#tab-panel-2608)
...
const STATE\_KEY = "mcp-transport-state";
...
export class MyStatefulMcpAgent extends Agent {
 ...
 return this.ctx.storage.get(STATE\_KEY);

 },

 set: (state) => {

 this.ctx.storage.put(STATE\_KEY, state);
...
\\* \[ JavaScript \](#tab-panel-2599)
\\* \[ TypeScript \](#tab-panel-2600)
...
\\* \[ JavaScript \](#tab-panel-2605)
\\* \[ TypeScript \](#tab-panel-2606)
...
\\* \[ JavaScript \](#tab-panel-2603)
\\* \[ TypeScript \](#tab-panel-2604)
...
\\* \[ JavaScript \](#tab-panel-2591)
\\* \[ TypeScript \](#tab-panel-2592)
...
\\* \[ JavaScript \](#tab-panel-2597)
\\* \[ TypeScript \](#tab-panel-2598)
...
\\* \[ JavaScript \](#tab-panel-2613)
\\* \[ TypeScript \](#tab-panel-2614)
...
\\* \[ JavaScript \](#tab-panel-2619)
\\* \[ TypeScript \](#tab-panel-2620)
...
\\* \[ JavaScript \](#tab-panel-2615)
\\* \[ TypeScript \](#tab-panel-2616)

JavaScript

\`\`\`

import { subscribe } from "node:diagnostics\_channel";
...
\\* \[ JavaScript \](#tab-panel-2621)
\\* \[ TypeScript \](#tab-panel-2622)
...
\\* \[ JavaScript \](#tab-panel-2623)
\\* \[ TypeScript \](#tab-panel-2624)
...
\\* \[ JavaScript \](#tab-panel-2617)
\\* \[ TypeScript \](#tab-panel-2618)
...
\\* No \`cf\_agent\_identity\`, \`cf\_agent\_state\`, or \`cf\_agent\_mcp\_servers\` messages are sent on connect
...
\\* \[ JavaScript \](#tab-panel-2627)
\\* \[ TypeScript \](#tab-panel-2628)
...
\\* \[ JavaScript \](#tab-panel-2629)
\\* \[ TypeScript \](#tab-panel-2630)
...
\\* \[ JavaScript \](#tab-panel-2631)
\\* \[ TypeScript \](#tab-panel-2632)
...
export class SensorHub extends Agent {
 ...
 .sql\`INSERT INTO readings (sensor\_id, value, ts) VALUES (${sensorId}, ${value}, ${Date.now()})\`;
...
type QueueItem = {
 ...
 created\_at: number; // Timestamp when the task was created
...
3\. \*\*FIFO order\*\*: Tasks are processed in the order they were created (\`created\_at\` timestamp).
...
7\. \*\*Persistence\*\*: Tasks are stored in the \`cf\_agents\_queues\` SQL table and survive agent restarts.
...
\\* \[ JavaScript \](#tab-panel-2647)
\\* \[ TypeScript \](#tab-panel-2648)
...
\\* \[ JavaScript \](#tab-panel-2655)
\\* \[ TypeScript \](#tab-panel-2656)
...
export class RAGAgent extends Agent {
 ...
 let searchResults = await this.env.VECTOR\_DB.query(queryVector.data\[0\], {
...
\\* \[ wrangler.jsonc \](#tab-panel-2653)
\\* \[ wrangler.toml \](#tab-panel-2654)
...
\
 "binding": "VECTOR\_DB",\
\
 "index\_name": "your-vectorize-index-name",\
\
 },\
\
 \],
...
\\* \[ JavaScript \](#tab-panel-2663)
\\* \[ TypeScript \](#tab-panel-2664)
...
\\* \[ JavaScript \](#tab-panel-2669)
\\* \[ TypeScript \](#tab-panel-2670)
...
\\* \[ JavaScript \](#tab-panel-2665)
\\* \[ TypeScript \](#tab-panel-2666)
...
\\* \[ JavaScript \](#tab-panel-2661)
\\* \[ TypeScript \](#tab-panel-2662)
...
\\* \*\*Client-side \`setState()\`\*\* — the server sends a \`cf\_agent\_state\_error\` message. Handle it with the \`onStateUpdateError\` callback.
...
\\* \[ JavaScript \](#tab-panel-2685)
\\* \[ TypeScript \](#tab-panel-2686)
...
\\* \[ JavaScript \](#tab-panel-2687)
\\* \[ TypeScript \](#tab-panel-2688)
...
\\* \[ JavaScript \](#tab-panel-2689)
\\* \[ TypeScript \](#tab-panel-2690)
...
agent.call("joinAsPlayer")} disabled={canEdit}>

Join as Player

agent.call("startSpectatorMode")}
...
\\* \[ JavaScript \](#tab-panel-2673)
\\* \[ TypeScript \](#tab-panel-2674)
...
\\* \[ JavaScript \](#tab-panel-2677)
\\* \[ TypeScript \](#tab-panel-2678)
...
\\* \[ JavaScript \](#tab-panel-2681)
\\* \[ TypeScript \](#tab-panel-2682)
...
\\* \[ JavaScript \](#tab-panel-2683)
\\* \[ TypeScript \](#tab-panel-2684)
...
\\* \[ JavaScript \](#tab-panel-2695)
\\* \[ TypeScript \](#tab-panel-2696)
...
\\* \[ JavaScript \](#tab-panel-2697)
\\* \[ TypeScript \](#tab-panel-2698)
...
\\* \[ JavaScript \](#tab-panel-2693)
\\* \[ TypeScript \](#tab-panel-2694)
...
\\* \[ JavaScript \](#tab-panel-2719)
\\* \[ TypeScript \](#tab-panel-2720)
...
\\* \[ JavaScript \](#tab-panel-2699)
\\* \[ TypeScript \](#tab-panel-2700)
...
\\* \[ JavaScript \](#tab-panel-2717)
\\* \[ TypeScript \](#tab-panel-2718)
...
\\* \[ JavaScript \](#tab-panel-2715)
\\* \[ TypeScript \](#tab-panel-2716)
...
\\* \[ JavaScript \](#tab-panel-2727)
\\* \[ TypeScript \](#tab-panel-2728)
...
\\* \[ JavaScript \](#tab-panel-2745)
\\* \[ TypeScript \](#tab-panel-2746)
...
\\* \[ JavaScript \](#tab-panel-2749)
\\* \[ TypeScript \](#tab-panel-2750)
...
\\* \[ JavaScript \](#tab-panel-2743)
\\* \[ TypeScript \](#tab-panel-2744)
...
\\* \[ JavaScript \](#tab-panel-2737)
\\* \[ TypeScript \](#tab-panel-2738)
...
\\* \[ JavaScript \](#tab-panel-2741)
\\* \[ TypeScript \](#tab-panel-2742)
...
\\* \[ JavaScript \](#tab-panel-2751)
\\* \[ TypeScript \](#tab-panel-2752)
...
\\* \[ JavaScript \](#tab-panel-2753)
\\* \[ TypeScript \](#tab-panel-2754)
...
\\* \[ JavaScript \](#tab-panel-2761)
\\* \[ TypeScript \](#tab-panel-2762)
...
\\* \[ JavaScript \](#tab-panel-2763)
\\* \[ TypeScript \](#tab-panel-2764)
...
\\* \[ JavaScript \](#tab-panel-2769)
\\* \[ TypeScript \](#tab-panel-2770)
...
\\* \[ JavaScript \](#tab-panel-2771)
\\* \[ TypeScript \](#tab-panel-2772)
...
\\* \[ JavaScript \](#tab-panel-2767)
\\* \[ TypeScript \](#tab-panel-2768)
...

{
 ...
 "bindings": \[\
\
 { "name": "Counter", "class\_name": "Counter" },\
\
 { "name": "ChatRoom", "class\_name": "ChatRoom" },\
\
 { "name": "UserProfile", "class\_name": "UserProfile" },\
\
 \],
...
\
 "tag": "v1",\
\
 "new\_sqlite\_classes": \["Counter", "ChatRoom", "UserProfile"\],\
\
 },\
\
 \],
...
class\_name = "ChatRoom"

\[\[durable\_objects.bindings\]\]

name = "UserProfile"

class\_name = "UserProfile"
...
\\* \[ JavaScript \](#tab-panel-2773)
\\* \[ TypeScript \](#tab-panel-2774)
...
\\* \[ JavaScript \](#tab-panel-2775)
\\* \[ TypeScript \](#tab-panel-2776)
...
2\. Class name in code matches \`class\_name\` in \`wrangler.jsonc\`.
...
\\* \[ JavaScript \](#tab-panel-2765)
\\* \[ TypeScript \](#tab-panel-2766)
...
\\* \[ JavaScript \](#tab-panel-2807)
\\* \[ TypeScript \](#tab-panel-2808)
...
\\* \[ JavaScript \](#tab-panel-2809)
\\* \[ TypeScript \](#tab-panel-2810)
...
export class MyAgent extends Agent {
 ...
 const instanceId = await this.runWorkflow("PROCESSING\_WORKFLOW", {
 ...
 .sql\`INSERT INTO results (task\_id, data) VALUES (${taskId}, ${JSON.stringify(result)})\`;
...
\\* \[ wrangler.jsonc \](#tab-panel-2779)
\\* \[ wrangler.toml \](#tab-panel-2780)
...

{
 ...
 "bindings": \[{ "name": "MY\_AGENT", "class\_name": "MyAgent" }\],
...
\
 "binding": "PROCESSING\_WORKFLOW",\
\
 "class\_name": "ProcessingWorkflow",\
\
 },\
\
 \],
...
await this.sendWorkflowEvent("MY\_WORKFLOW", instanceId, {
...
const status = await this.getWorkflowStatus("MY\_WORKFLOW", instanceId);
...
\\* \[ JavaScript \](#tab-panel-2815)
\\* \[ TypeScript \](#tab-panel-2816)
...
\\* \[ JavaScript \](#tab-panel-2801)
\\* \[ TypeScript \](#tab-panel-2802)
...
\\* \[ JavaScript \](#tab-panel-2795)
\\* \[ TypeScript \](#tab-panel-2796)
...
\\* \[ JavaScript \](#tab-panel-2797)
\\* \[ TypeScript \](#tab-panel-2798)
...
\\* \[ JavaScript \](#tab-panel-2799)
\\* \[ TypeScript \](#tab-panel-2800)
...
\\* \[ JavaScript \](#tab-panel-2803)
\\* \[ TypeScript \](#tab-panel-2804)
...
\\* \[ JavaScript \](#tab-panel-2811)
\\* \[ TypeScript \](#tab-panel-2812)
...
\\* \[ JavaScript \](#tab-panel-2805)
\\* \[ TypeScript \](#tab-panel-2806)
...
\\* \[ JavaScript \](#tab-panel-2813)
\\* \[ TypeScript \](#tab-panel-2814)
...
class MyAgent extends Agent {
 ...
 this.migrateWorkflowBinding("OLD\_WORKFLOW", "NEW\_WORKFLOW");
...
\\* \[ JavaScript \](#tab-panel-2817)
\\* \[ TypeScript \](#tab-panel-2818)
...
\\* \[ JavaScript \](#tab-panel-2829)
\\* \[ TypeScript \](#tab-panel-2830)
...
\\* \[ JavaScript \](#tab-panel-2831)
\\* \[ TypeScript \](#tab-panel-2832)
...
The internal \`cf\_agents\_workflows\` table can grow unbounded, so implement a retention policy:

\\* \[ JavaScript \](#tab-panel-2825)
\\* \[ TypeScript \](#tab-panel-2826)
...
\\* \[ JavaScript \](#tab-panel-2819)
\\* \[ TypeScript \](#tab-panel-2820)
...
\\* \[ JavaScript \](#tab-panel-2889)
\\* \[ TypeScript \](#tab-panel-2890)
...
\\* \[ JavaScript \](#tab-panel-2875)
\\* \[ TypeScript \](#tab-panel-2876)
...
\\* \[ JavaScript \](#tab-panel-2885)
\\* \[ TypeScript \](#tab-panel-2886)
...
\\* \[ JavaScript \](#tab-panel-2887)
\\* \[ TypeScript \](#tab-panel-2888)
...
\\* \[ JavaScript \](#tab-panel-2891)
\\* \[ TypeScript \](#tab-panel-2892)
...
\\* \[ JavaScript \](#tab-panel-2883)
\\* \[ TypeScript \](#tab-panel-2884)
...
\\* \[ JavaScript \](#tab-panel-2895)
\\* \[ TypeScript \](#tab-panel-2896)
...
\\* \[ JavaScript \](#tab-panel-2897)
\\* \[ TypeScript \](#tab-panel-2898)
...
\\* \[ JavaScript \](#tab-panel-2893)
\\* \[ TypeScript \](#tab-panel-2894)
...
\\* \[ JavaScript \](#tab-panel-2905)
\\* \[ TypeScript \](#tab-panel-2906)
...
\\* \[ JavaScript \](#tab-panel-2899)
\\* \[ TypeScript \](#tab-panel-2900)
...
\\* \[ JavaScript \](#tab-panel-2907)
\\* \[ TypeScript \](#tab-panel-2908)
...
async getMessages(limit = 50) {
 ...
 return this.sql\`SELECT \* FROM messages ORDER BY created\_at DESC LIMIT ${limit}\`;
...
export class ChatAgent extends Agent {
 ...
 INSERT INTO messages (id, text, user\_id, created\_at)
...
Modern reasoning models can take some time to both generate a response \_and\_ stream the response back to the client. Instead of buffering the entire response, you can stream it back over \[WebSockets\](https://developers.cloudflare.com/agents/api-reference/websockets/).

\\* \[ JavaScript \](#tab-panel-2933)
\\* \[ TypeScript \](#tab-panel-2934)
...
\\* \[ wrangler.jsonc \](#tab-panel-2921)
\\* \[ wrangler.toml \](#tab-panel-2922)
...
\\* \[ JavaScript \](#tab-panel-2931)
\\* \[ TypeScript \](#tab-panel-2932)
...
\\* \[ wrangler.jsonc \](#tab-panel-2923)
\\* \[ wrangler.toml \](#tab-panel-2924)
...
\\* \[ JavaScript \](#tab-panel-2935)
\\* \[ TypeScript \](#tab-panel-2936)
...
export class MyAgent extends Agent {
 ...
 apiKey: this.env.GEMINI\_API\_KEY,
...
\\* \[ JavaScript \](#tab-panel-2939)
\\* \[ TypeScript \](#tab-panel-2940)
...
\\* \[ JavaScript \](#tab-panel-2943)
\\* \[ TypeScript \](#tab-panel-2944)
...
\\* \[ JavaScript \](#tab-panel-2937)
\\* \[ TypeScript \](#tab-panel-2938)
...
\\* \[ JavaScript \](#tab-panel-2947)
\\* \[ TypeScript \](#tab-panel-2948)
...
\\* \[ JavaScript \](#tab-panel-2955)
\\* \[ TypeScript \](#tab-panel-2956)
...
\\* \[ JavaScript \](#tab-panel-2941)
\\* \[ TypeScript \](#tab-panel-2942)
...
\\* \[ JavaScript \](#tab-panel-2961)
\\* \[ TypeScript \](#tab-panel-2962)
...
export class ResearchAgent extends Agent {
 ...
 SELECT key, value FROM user\_preferences\`;
...
\\* \[ JavaScript \](#tab-panel-2965)
\\* \[ TypeScript \](#tab-panel-2966)
...
export class DigestAgent extends Agent {
 ...
 WHERE created\_at > datetime('now', '-1 day')\`;
 ...
 this.sql\`INSERT INTO digests (summary, created\_at)
...
\\* \[ JavaScript \](#tab-panel-2969)
\\* \[ TypeScript \](#tab-panel-2970)
...
export class TriageAgent extends Agent {
 ...
 const similar = await this.env.VECTOR\_DB.query(embedding, { topK: 5 });
 ...
 this.sql\`INSERT INTO tickets (content, category, response, created\_at)
...
\\* \[ JavaScript \](#tab-panel-2967)
\\* \[ TypeScript \](#tab-panel-2968)
...
export class CachingAgent extends Agent {
 ...
 SELECT response FROM llm\_cache WHERE prompt = ${prompt}\`;
 ...
 this.sql\`INSERT INTO llm\_cache (prompt, response, created\_at)
...
!\[A human-in-the-loop diagram\](https://developers.cloudflare.com/\_astro/human-in-the-loop.C2xls7fV\_ZMwbba.svg)
...
!\[Traditional workflow automation diagram\](https://developers.cloudflare.com/\_astro/workflow-automation.D1rsykgR\_Z1dw1Js.svg)
...
!\[A co-pilot diagram\](https://developers.cloudflare.com/\_astro/co-pilot.BZ\_kRuK6\_Z2sKyKr.svg)
...
!\[An agent diagram\](https://developers.cloudflare.com/\_astro/agent-workflow.5VDKtHdO\_Z1Hdwi1.svg)
...
\\* \[ JavaScript \](#tab-panel-2971)
\\* \[ TypeScript \](#tab-panel-2972)
...
\\* \[ JavaScript \](#tab-panel-2973)
\\* \[ TypeScript \](#tab-panel-2974)
...
\\* \[ JavaScript \](#tab-panel-2975)
\\* \[ TypeScript \](#tab-panel-2976)
...
\`\`\`
{
 ...
 "name": "Example Server",
 "state": "ready",
 "server\_url": "https://docs.mcp.cloudflare.com/mcp",
 ...
 }
 },
 "tools": \[\
...
const validateToken = async (token) => {
 ...
 const res = await fetch(\`${API\_HOST}/api/users/me\`, {
...
export class SecureAgent extends Agent {
 ...
 const payload = await verifyJWT(token, this.env.JWT\_SECRET);
...
class ExpenseAgent extends Agent {
 ...
 const workflowId = await this.runWorkflow("EXPENSE\_WORKFLOW", expense);
...
class ExpenseAgent extends Agent {
 ...
 CREATE TABLE IF NOT EXISTS approval\_audit (

 id INTEGER PRIMARY KEY AUTOINCREMENT,

 workflow\_id TEXT NOT NULL,

 decision TEXT NOT NULL CHECK(decision IN ('approved', 'rejected')),

 decided\_by TEXT NOT NULL,

 decided\_at INTEGER NOT NULL,
 ...
 INSERT INTO approval\_audit (workflow\_id, decision, decided\_by, decided\_at, reason)
...
\\* \[ wrangler.jsonc \](#tab-panel-3062)
\\* \[ wrangler.toml \](#tab-panel-3063)
...

{
 ...
 "bindings": \[{ "name": "EXPENSE\_AGENT", "class\_name": "ExpenseAgent" }\],
...
\
 "binding": "EXPENSE\_WORKFLOW",\
\
 "class\_name": "ExpenseWorkflow",\
\
 },\
\
 \],

 "migrations": \[{ "tag": "v1", "new\_sqlite\_classes": \["ExpenseAgent"\] }\],
...
new\_sqlite\_classes = \[ "ExpenseAgent" \]
...
agent.stub.approve(item.workflowId, "admin")}

>

Approve

agent.stub.reject(item.workflowId, "Declined")}
...
{server.state === "authenticating" && server.auth\_url && (

window.open(server.auth\_url, "\_blank")}>
...
handleRetry(id, server.server\_url, server.name)}
...
2\. For the OAuth app you just created, add the client ID of the OAuth app as \`GITHUB\_CLIENT\_ID\` and generate a client secret, adding it as \`GITHUB\_CLIENT\_SECRET\` to a \`.env\` file in the root of your project, which \[will be used to set secrets in local development\](https://developers.cloudflare.com/workers/configuration/secrets/).
Terminal window
\`\`\`
touch .env
echo 'GITHUB\_CLIENT\_ID="your-client-id"' >> .env
echo 'GITHUB\_CLIENT\_SECRET="your-client-secret"' >> .env
cat .env
\`\`\`
...
npx wrangler secret put GITHUB\_CLIENT\_ID
...
npx wrangler secret put GITHUB\_CLIENT\_SECRET

\`\`\`

\`\`\`

npx wrangler secret put COOKIE\_ENCRYPTION\_KEY # add any random string here e.g. openssl rand -hex 32
...
Terminal window
\`\`\`
npx wrangler kv namespace create "OAUTH\_KV"
\`\`\`
...
function generateCSRFProtection() {
 ...
 const setCookie = \`\_\_Host-CSRF\_TOKEN=${token}; HttpOnly; Secure; Path=/; SameSite=Lax; Max-Age=600\`;
...
function validateCSRFToken(formData, request) {
 ...
 const tokenFromForm = formData.get("csrf\_token");
 ...
 .find((c) => c.trim().startsWith("\_\_Host-CSRF\_TOKEN="))
 ...
 clearCookie: \`\_\_Host-CSRF\_TOKEN=; HttpOnly; Secure; Path=/; SameSite=Lax; Max-Age=0\`,
...
async function bindStateToSession(stateToken) {
 ...
 setCookie: \`\_\_Host-CONSENTED\_STATE=${hashHex}; HttpOnly; Secure; Path=/; SameSite=Lax; Max-Age=600\`,
...
\### Why use the \`\_\_Host-\` prefix?

The \`\_\_Host-\` prefix prevents subdomain attacks, which is especially important on \`\*.workers.dev\` domains:

\\* Must be set with \`Secure\` flag (HTTPS only)
\\* Must have \`Path=/\`
\\* Must not have a \`Domain\` attribute

Without \`\_\_Host-\`, an attacker controlling \`evil.workers.dev\` could set cookies for your \`mcp-server.workers.dev\` domain.
...
\_\_Host-CSRF\_TOKEN\_GITHUB

\_\_Host-CSRF\_TOKEN\_GOOGLE

\_\_Host-APPROVED\_CLIENTS\_GITHUB

\_\_Host-APPROVED\_CLIENTS\_GOOGLE
...
async function addApprovedClient(request, clientId, cookieSecret) {
 ...
 return \`\_\_Host-APPROVED\_CLIENTS=${cookieValue}; HttpOnly; Secure; Path=/; SameSite=Lax; Max-Age=2592000\`;
...
\\* \`app\_mentions:read\` — Receive mentions
...
\\* \`app\_mention\` — When the bot is @mentioned
...
OPENAI\_BASE\_URL="https://gateway.ai.cloudflare.com/v1/YOUR\_ACCOUNT\_ID/YOUR\_GATEWAY/openai"

\`\`\`

Note

The \`OPENAI\_BASE\_URL\` is optional but recommended. Using \[Cloudflare AI Gateway\](https://developers.cloudflare.com/ai-gateway/) gives you caching, rate limiting, and analytics for your AI requests.

1\. Update your \`wrangler.jsonc\` to configure your Agent:

\\* \[ wrangler.jsonc \](#tab-panel-3113)
\\* \[ wrangler.toml \](#tab-panel-3114)
...
Be brief, specific, and actionable. If you're unsure, ask a single clarifying question.\`;
 ...
 if (event.bot\_id \|\| event.subtype) return;
 ...
 const thread = await this.fetchThread(e.channel, e.thread\_ts \|\| e.ts);
...
export default MyAgent.listen({
 ...
 clientId: env.SLACK\_CLIENT\_ID,

 clientSecret: env.SLACK\_CLIENT\_SECRET,

 slackSigningSecret: env.SLACK\_SIGNING\_SECRET,
...
npx wrangler secret put SLACK\_CLIENT\_ID

npx wrangler secret put SLACK\_CLIENT\_SECRET

npx wrangler secret put SLACK\_SIGNING\_SECRET

npx wrangler secret put OPENAI\_API\_KEY

npx wrangler secret put OPENAI\_BASE\_URL

\`\`\`

Note

You can skip \`OPENAI\_BASE\_URL\` if you're not using AI Gateway.
...
\\* Each workspace's \`team\_id\` is used as the Durable Object ID.
...
export class WebhookAgent extends Agent {
 ...
 !(await this.verifySignature(body, signature, this.env.WEBHOOK\_SECRET))
...
\\* \[ JavaScript \](#tab-panel-3119)
\\* \[ TypeScript \](#tab-panel-3120)
...
export default {
 ...
 const repoFullName = payload.repository?.full\_name;
...
\\* \[ JavaScript \](#tab-panel-3115)
\\* \[ TypeScript \](#tab-panel-3116)

JavaScript

\`\`\`

// Webhook URL: https://your-worker.dev/webhooks/stripe/cus\_123456

if (url.pathname.startsWith("/webhooks/stripe/")) {

 const customerId = url.pathname.split("/")\[3\]; // "cus\_123456"
...
\\* \[ JavaScript \](#tab-panel-3117)
\\* \[ TypeScript \](#tab-panel-3118)
...
\\* \[ JavaScript \](#tab-panel-3127)
\\* \[ TypeScript \](#tab-panel-3128)
...
class WebhookAgent extends Agent {
 ...
 CREATE INDEX IF NOT EXISTS idx\_events\_timestamp
...
\\* \[ JavaScript \](#tab-panel-3121)
\\* \[ TypeScript \](#tab-panel-3122)
...
\\* \[ JavaScript \](#tab-panel-3141)
\\* \[ TypeScript \](#tab-panel-3142)
...
export default {
 ...
 const repoName = payload.repository?.full\_name?.replace("/", "-");
...
export class NotificationAgent extends Agent {
 ...
 const response = await fetch(this.env.SLACK\_WEBHOOK\_URL, {
 ...
 const signature = await this.sign(body, this.env.WEBHOOK\_SECRET);
...
\\* \[ JavaScript \](#tab-panel-3125)
\\* \[ TypeScript \](#tab-panel-3126)
...
// wrangler secret put GITHUB\_WEBHOOK\_SECRET

// Access in agent

const secret = this.env.GITHUB\_WEBHOOK\_SECRET;
