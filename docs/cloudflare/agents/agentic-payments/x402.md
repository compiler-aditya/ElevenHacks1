...
[Skip to content](https://developers.cloudflare.com/agents/agentic-payments/x402/#_top)
...
4. The server verifies the payment payload — directly or by calling a [facilitator](https://developers.cloudflare.com/agents/agentic-payments/x402/#the-facilitator) — and settles the transaction on-chain.
