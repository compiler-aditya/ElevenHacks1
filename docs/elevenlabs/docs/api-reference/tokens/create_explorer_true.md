# Source: https://elevenlabs.io/docs/api-reference/tokens/create?explorer=true

Generate a time limited single-use token with embedded authentication for frontend clients.

### Path parameters

token\_typeenumRequired

Allowed values:realtime\_scribetts\_websocket
...
Single Use Create Request Unprocessable Entity Error
...
POSThttps://api.elevenlabs.io/v1/single-use-token/realtime\_scribe
