...
[Add Real‑Time Data to Your Agent – Server Webhook Tools Explained](https://www.youtube.com/watch?v=pB33QxKN8P8) [ElevenLabs](https://www.youtube-nocookie.com/channel/UC-ew9TfeD887qUSiWWAAj1w)
...
[Watch on](https://www.youtube.com/watch?v=pB33QxKN8P8)
...
tools](https://elevenlabs.io/docs/eleven-agents/customization/tools/client-tools) instead.
