...
[Connect Custom Tools to Your Agent with MCP – Model Context Protocol Tutorial](https://www.youtube.com/watch?v=m1HgNvafID8) [ElevenLabs](https://www.youtube.com/channel/UC-ew9TfeD887qUSiWWAAj1w)
...
[Watch on](https://www.youtube.com/watch?v=m1HgNvafID8)
...
Guidelines](https://elevenlabs.io/docs/eleven-agents/customization/tools/mcp/security) before proceeding.

Refer to our [MCP Integration Security Guidelines](https://elevenlabs.io/docs/eleven-agents/customization/tools/mcp/security) for detailed best practices.
