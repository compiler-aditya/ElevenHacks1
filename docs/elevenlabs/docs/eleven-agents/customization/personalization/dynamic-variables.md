...
Assignments are a field of each server tool, that can be found documented [here](https://elevenlabs.io/docs/eleven-agents/api-reference/tools/create#response.body.tool_config.SystemToolConfig.assignments).
...
- A configured ElevenLabs Conversational Agent ( [create one here](https://elevenlabs.io/docs/eleven-agents/quickstart))
...
Ensure you have the latest [SDK](https://elevenlabs.io/docs/eleven-agents/libraries/python) installed.
