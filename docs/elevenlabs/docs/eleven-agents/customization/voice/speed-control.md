# Source: https://elevenlabs.io/docs/eleven-agents/customization/voice/speed-control
...
![Speed control settings under the Voice tab](https://files.buildwithfern.com/https://elevenlabs.docs.buildwithfern.com/docs/4a1dfe1db33f9f03bb614b56173c7c00596f2d6c36b0f17ce43f151bd4d07f66/assets/images/conversational-ai/speed-control.png)

## Configuration

Speed is controlled through the [`speed` parameter](https://elevenlabs.io/docs/api-reference/agents/create#request.body.conversation_config.tts.speed) with the following specifications:
