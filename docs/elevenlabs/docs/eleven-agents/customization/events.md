# Source: https://elevenlabs.io/docs/eleven-agents/customization/events
...
system signals.](https://elevenlabs.io/docs/eleven-agents/customization/events/client-events) [Client-to-Server Events\\
\\
Events sent from the client to the server, providing contextual updates or responding to server\\
requests.](https://elevenlabs.io/docs/eleven-agents/customization/events/client-to-server-events)