# Source: https://elevenlabs.io/docs/eleven-agents/api-reference/agents/update?explorer=true
...
PATCHhttps://api.elevenlabs.io/v1/convai/agents/agent\_3701k3ttaq12ewp8b7qv5rfyszkz?enable\_versioning\_if\_not\_enabled=true&branch\_id=branch\_id
...
- enable\_versioning\_if\_not\_enabledbooleanDefaults to `false`
...
6 optional propertiesconversation\_config, platform\_settings, workflow, name, tags, version\_description
...
```
curl -X PATCH "https://api.elevenlabs.io/v1/convai/agents/agent_3701k3ttaq12ewp8b7qv5rfyszkz?enable_versioning_if_not_enabled=true&branch_id=branch_id" \
