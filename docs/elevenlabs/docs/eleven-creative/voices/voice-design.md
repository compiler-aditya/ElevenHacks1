# Source: https://elevenlabs.io/docs/eleven-creative/voices/voice-design

Make the Best AI Voices with Emotion (Realistic TTS) - YouTube

Tap to unmute

[Make the Best AI Voices with Emotion (Realistic TTS)](https://www.youtube.com/watch?v=_cEcV96wQ1k) [ElevenLabs](https://www.youtube.com/channel/UC-ew9TfeD887qUSiWWAAj1w)
...
[Watch on](https://www.youtube.com/watch?v=_cEcV96wQ1k)

![Voice design](https://files.buildwithfern.com/https://elevenlabs.docs.buildwithfern.com/docs/1125280670aac11f82425cb9e04ccba451fb85ac046cff42203b867a82340f43/assets/images/product-guides/voices/voices-voice-design.png)

## Overview

Voice Design helps creators fill the gaps when the exact voice they are looking for isn’t available in the [Voice Library](https://elevenlabs.io/app/voice-library). If you can’t find a suitable voice for your project, you can create one. Voice Design is best for quick exploration and iteration, and output quality can vary depending on your prompt and use case. If you need the most consistent, production-ready quality, [Professional Voice Clones (PVC)](https://elevenlabs.io/docs/eleven-creative/voices/voice-cloning) are currently the highest quality voices on our platform - so if there is a PVC available in our library that fits your needs, we recommend using it instead.

You can find Voice Design by heading to Voices -> My Voices -> Add a new voice -> Voice Design in the [ElevenLabs app](https://elevenlabs.io/app/voice-lab?create=true&creationType=voiceDesign) or via the [API](https://elevenlabs.io/docs/api-reference/text-to-voice/design).
...
[API reference\\
\\
See the API reference for Voice Design](https://elevenlabs.io/docs/api-reference/text-to-voice) [Example app\\
\\
A Next.js example app for Voice Design](https://github.com/elevenlabs/examples/tree/main/examples/text-to-voice/x-to-voice)
