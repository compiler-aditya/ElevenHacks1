# Source: https://elevenlabs.io/docs/eleven-creative/playground/speech-to-text

![Text to Speech product feature](https://files.buildwithfern.com/https://elevenlabs.docs.buildwithfern.com/docs/0c8dba5ebba5f9a72541640bb4a9c9fac7bd265df0549f80cb5557c022f85b6f/assets/images/product-guides/speech-to-text/speech-to-text-product-feature.webp)
...
[1](https://elevenlabs.io/docs/eleven-creative/playground/speech-to-text#upload-audio)
...
[2](https://elevenlabs.io/docs/eleven-creative/playground/speech-to-text#select-options)
...
[3](https://elevenlabs.io/docs/eleven-creative/playground/speech-to-text#view-results)
...
Once you’ve created a transcript, you can edit it in our Transcript Editor. Learn more about it [in this guide](https://elevenlabs.io/docs/eleven-creative/products/transcripts).
