...
Generate Image & Video with ElevenLabs (Full Tutorial) - YouTube

Tap to unmute

[Generate Image & Video with ElevenLabs (Full Tutorial)](https://www.youtube.com/watch?v=BmMxkpm12vc) [ElevenLabs](https://www.youtube.com/channel/UC-ew9TfeD887qUSiWWAAj1w)
...
[Watch on](https://www.youtube.com/watch?v=BmMxkpm12vc)
...
[1](https://elevenlabs.io/docs/eleven-creative/playground/image-video#select-your-mode)

### Select your mode

Use the toggle in the upper right corner of the prompt box to choose between **Image** or **Video** generation.

[2](https://elevenlabs.io/docs/eleven-creative/playground/image-video#provide-a-prompt-or-reference)
...
[3](https://elevenlabs.io/docs/eleven-creative/playground/image-video#choose-a-model-and-settings)

### Choose a model and settings

Select the ideal generative model for your goal (e.g., OpenAI Sora 2 Pro, Google Veo 3.1, Kling 2.5, Flux 1 Kontext Pro). See the [Models](https://elevenlabs.io/docs/eleven-creative/playground/image-video#models) section for detailed information on each model. Adjust settings like aspect ratio, resolution, duration (for video), and the number of variations to generate.

[4](https://elevenlabs.io/docs/eleven-creative/playground/image-video#generate-your-asset)

### Generate your asset

Click the **[Generate](https://elevenlabs.io/docs/eleven-creative/playground/image-video#generate-1)** button. Your assets will be created and displayed in the **[History](https://elevenlabs.io/docs/eleven-creative/playground/image-video#history-1)** tab for review.

[5](https://elevenlabs.io/docs/eleven-creative/playground/image-video#enhance-and-refine)
...
[6](https://elevenlabs.io/docs/eleven-creative/playground/image-video#share-with-others)
...
[7](https://elevenlabs.io/docs/eleven-creative/playground/image-video#export-your-creation)
...
### [Explore](https://elevenlabs.io/docs/eleven-creative/playground/image-video\#explore-1)

Discover community creations to find inspiration, study effective prompts, or pull references directly into your own work.

### [Generate](https://elevenlabs.io/docs/eleven-creative/playground/image-video\#generate-1)
...
### [History](https://elevenlabs.io/docs/eleven-creative/playground/image-video\#history-1)
...
### [Export](https://elevenlabs.io/docs/eleven-creative/playground/image-video\#export-1)
...
**Select model:** Open the model menu to browse available options like OpenAI Sora 2 Pro, Google Veo 3.1, Kling 2.5, or Flux 1 Kontext Pro. Each model has unique strengths and capabilities listed for easy comparison. See the [Models](https://elevenlabs.io/docs/eleven-creative/playground/image-video#models) section for detailed information.
...
![Video references interface](https://files.buildwithfern.com/https://elevenlabs.docs.buildwithfern.com/docs/cb430f8e80b038841bc42eec541ac42046d4198802d6e9a5c1596e54bae032f1/assets/images/product-guides/images-videos/videos-prompt-references.webp)
