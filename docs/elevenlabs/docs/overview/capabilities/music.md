...
[Music\\
\\
Step-by-step guide for using Eleven Music on the ElevenCreative Platform.](https://elevenlabs.io/docs/eleven-creative/products/music) [Developers\\
\\
Step-by-step guide for using Eleven Music with the API.](https://elevenlabs.io/docs/eleven-api/guides/cookbooks/music) [Prompting guide\\
\\
Learn how to use Eleven Music with natural language prompts.](https://elevenlabs.io/docs/overview/capabilities/music/best-practices) [Music Finetunes\\
\\
Learn how to train a custom music model on your own audio.](https://elevenlabs.io/docs/eleven-creative/products/music/finetunes)
...
Yes, refer to the [developer quickstart](https://elevenlabs.io/docs/eleven-api/guides/cookbooks/music) for more
information.
