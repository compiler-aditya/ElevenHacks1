...
The ElevenLabs [Speech to Text (STT) API](https://elevenlabs.io/docs/eleven-api/guides/cookbooks/speech-to-text/quickstart) turns spoken audio into text with state of the art accuracy. Our [Scribe v2 model](https://elevenlabs.io/docs/overview/models) adapts to textual cues across 90+ languages and multiple voice styles. To try a live demo please visit our [Speech to Text](https://elevenlabs.io/speech-to-text) showcase page.

[Products\\
\\
Step-by-step guide for using speech to text in ElevenLabs.](https://elevenlabs.io/docs/eleven-creative/playground/speech-to-text) [Developers\\
\\
Learn how to integrate the speech to text API into your application.](https://elevenlabs.io/docs/eleven-api/guides/cookbooks/speech-to-text/quickstart) [Realtime speech to text\\
\\
Learn how to transcribe audio with ElevenLabs in realtime with WebSockets.](https://elevenlabs.io/docs/eleven-api/guides/how-to/speech-to-text/realtime/client-side-streaming) [API reference\\
\\
...
[\|\|ElevenLabs](https://elevenlabs.io/?utm_medium=audionative&utm_source=audionative_host_url_not_found&utm_campaign=audionative_host_url_not_found&utm_term=public_user_id_not_found&utm_content=project_id_not_found)
...
Highlight up to 1000 words or phrases to bias the model towards transcribing them. This is useful for transcribing specific words or sentences that are not common in the audio, such as product names, names, or other specific terms. Keyterms are more powerful than biased keywords or customer vocabularies offered by other models, because it relies on the context to decide whether to transcribe that term or not.

To learn more about how to use keyterm prompting, see the [keyterm prompting documentation](https://elevenlabs.io/docs/eleven-api/guides/how-to/speech-to-text/batch/keyterm-prompting).
...
For a full list of supported entities, see the [entity detection documentation](https://elevenlabs.io/docs/eleven-api/guides/how-to/speech-to-text/batch/entity-detection).
...
Yes, asynchronous transcription results can be sent to webhooks configured in webhook settings in the UI. Learn more in the [webhooks cookbook](https://elevenlabs.io/docs/eleven-api/guides/how-to/speech-to-text/batch/webhooks).
